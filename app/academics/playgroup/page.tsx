...
export const metadata: Metadata = {
  title: "Playgroup",
  description:
    "Early childhood learning at Hopewell STEM Academy — where young minds explore, play and discover through STEM.",
};
...
export default function PlaygroupPage() {
  return (
    <>
      <PageHero
        title="Playgroup"
        subtitle="Early discovery and imagination — the joyful first step in your child's learning journey."
      ...
      <IntroSplit
        ...
        paragraphs={[
          ...
          "Through stories, songs, art and hands-on discovery, our little learners build confidence, social skills and a lifelong love of learning — guided every step of the way by caring, qualified teachers.",
        ]}
